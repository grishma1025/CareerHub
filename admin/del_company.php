<?php include "header.php";
 ...
 {
	$getid=$_GET['delete'];
	$delete="delete from tbl_company where id='$getid' ";
	
	$query=mysqli_query($connection,$delete) or die('Error in delete company->'.mysqli_error($connection));
	
	if($query)
	{
	?>
	<script>alert("Successfully deleted company!");
...
?>
	...
	<?php
	$getid=$_GET['delete'];
	$sel="select * from tbl_company where id='$getid';";
