<?php include "header.php";
 ...
 {
	$getid=$_GET['delete'];
	$delete="delete from tbl_registration_employers where id='$getid' ";
	...
	{
	?>
	<script>alert("Successfully deleted Employer!");
...
?>
	...
	<?php
	$getid=$_GET['delete'];
	$sel="select * from tbl_registration_employers where id='$getid';";
